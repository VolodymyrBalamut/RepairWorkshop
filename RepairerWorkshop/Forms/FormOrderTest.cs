    ...
    public partial class FormOrderTest : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Замовлення передано на тестування", "Успіх", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch
            {
                MessageBox.Show("Замовлення не передано на тестування", "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                // Close the connection
